...
const Newexperience = () => {
    ...
    const createExperience = async (e) => {
        ...
        await axios.post('/api/add_experience',formData)
    ...
    <>
        ...
        <div className="container">
            ...
            <div className="card">
  <h5 className="card-header">Add New Experience</h5>
  <div className="card-body">
     ...
     */}
    <input type="text" value={experience_title} onChange={(event) => {setexperience_title(event.target.value)}} name="title" className="form-control mb-4" placeholder="title"/>
    <input type="text" value={experience_description} onChange={(event) => {setexperience_description(event.target.value)}} name="description" className="form-control mb-4" placeholder="description"/>
    <input type="text" value={experience_date} onChange={(event) => {setexperience_date(event.target.value)}} name="project_date" className="form-control mb-4" placeholder="experience_date"/>
    ...
    */}
    <button href="#" onClick={(event) => createExperience(event)} className="btn btn-primary">Add Project</button>
    </form>
  </div>
</div>
</div>
